                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <p>
                                            <a> Harga: <?php echo $row['price']; ?></a>
                                     										...
                                     										<?php if($total_qty > 0){ ?>
                                        <a href="#add<?php echo $id; ?>"   data-toggle="modal" class="btn btn-success"><i class="icon-shopping-cart icon-large"></i>&nbsp;Beli</a>
										<?php }else{ ?>
										<span class="label label-important">Habis</span>
										<?php } ?>
