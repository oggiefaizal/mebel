    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Meubel&nbsp;</a>
            </div>
						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <div class="alert alert-info">
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Member</strong>
                                </div>
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysql_fetch_array($query)) {
                                        ...
                                        <tr class="warning">
                                            ...
                                            <td width="160">
                                                <a href="#delete_product<?php echo $user_id; ?>" role="button"  data-target = "#delete_product<?php echo $user_id;?>"data-toggle="modal" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Hapus</a>
