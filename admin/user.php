						...
						<div class="hero-unit-table">   
                               ...
                               <table cellpadding="0" cellspacing="0" border="0" class="table table-condensed table-striped table-bordered" id="dataTables-example">
                                <div class="alert alert-info">
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Daftar User</strong>
                                </div>
                                <thead>
                                    <tr>
                                        <th>Username</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysql_fetch_array($query)) {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td width="80">
                                                <a href="#delete_user<?php echo $user_id; ?>" role="button"  data-toggle="modal" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Hapus</a>
                                                 </td>
                                            <!-- user delete modal -->
